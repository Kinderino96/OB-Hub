    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100vh" }}>
      <header style={{
        ...
        <span style={{
          ...
          background: dashboard.iconBg, color: dashboard.iconColor, fontFamily: "monospace",
        }}>
          {dashboard.category}
        </span>
        <div style={{ marginLeft: "auto" }}>
          <a href={dashboard.url} target="_blank" rel="noopener noreferrer" style={{
            ...
            border: "1px solid #e2e0d8", borderRadius: 6, padding: "5px 12px", background: "#fff",
          }}>
      ...
      <iframe src={dashboard.url} style={{ flex: 1, border: "none", display: "block" }} title={dashboard.title} />
    </div>
  );
}
